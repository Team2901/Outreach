 ...
 */
public class BasicTwoWheelPhysicsBase extends VirtualBot {
    ...
    public BasicTwoWheelPhysicsBase(){
        super();
    ...
    public void initialize(){
        ...
        leftMotor = (DcMotorExImpl)hardwareMap.get(DcMotorEx.class, "leftDrive");
        rightMotor = (DcMotorExImpl)hardwareMap.get(DcMotorEx.class, "rightDrive");
    ...
    protected void createHardwareMap(){
        ...
        hardwareMap.put("leftDrive", new DcMotorExImpl(MOTOR_TYPE, motorController0, 0));
        hardwareMap.put("rightDrive", new DcMotorExImpl(MOTOR_TYPE, motorController0, 1));
